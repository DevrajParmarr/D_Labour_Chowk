...
// Updated query to join the tables
$query = "
SELECT lp.*, u.user_name, u.mobile_no 
FROM lab_post lp
...
<head>
    ...
    <style>
        ...
        .job-city i, .job-salary i, .job-name i {
            margin-right: 8px;
        }
        ...
        .apply-btn, .contact-btn, .profile-btn {
        ...
        .apply-btn:hover, .contact-btn:hover, .profile-btn:hover {
...
<div class="container">
    <h1 class="heading">Explore the Best Labour for Your Work</h1>
                ...
                <div class='job-card'>
                    ...
                    <div class='job-content'>
                        ...
                        <form action='contact.php' method='POST'>
                            <input type='hidden' name='user_id' value='{$dbrow['user_ID']}'>
                            <button type='submit' class='contact-btn'>Contact Now</button>
                        </form>
